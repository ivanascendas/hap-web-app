        ...
        <Box className="table-statements-mobile_group" key={yearMounth}>
          ...
          <Box className="table-statements-mobile_group_list">
            {statements[yearMounth].map((statemet, i) => (
              <Button
                fullWidth
                onClick={() => onClick && onClick(statemet)}
                key={yearMounth + i}
                className="table-statements-mobile_group_list_item ripple"
              >
                <Box style={{ width: "60px !important", flex: "none" }}>
                ...
                <Box
                  className={`table-statements-mobile_group_list_item_amount ${statemet.transType == "Invoice" ? "text_red" : "clr_green"}`}
                >
