          ...
          <div className="page_wrap_height">
            <header className="page_wrap_height_title policy_title">
              <div className="h_title cookie_title">
                <b> {t("COOKIE_PAGE.SUB_TITLE")}</b>
                <br />
                <span
                  dangerouslySetInnerHTML={{ __html: t("COOKIE_PAGE.TITLE") }}
                ></span>
              </div>
            </header>

            <div
              className="personal_box cookie_box"
              role="main"
              dangerouslySetInnerHTML={{ __html: t("COOKIE_PAGE.CONTENT") }}
            ></div>
          </div>
        </div>
