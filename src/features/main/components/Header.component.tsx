...
export const HeaderComponent = ({ toogleDrawer }: HeaderProps): JSX.Element => {
    ...
    const settings = [t('CONTENTS.NAV.ACCOUNT_INF'), t('CONTENTS.NAV.MESSAGES'), t('CONTENTS.NAV.CHANGE_PASSWORD'), t('CONTENTS.NAV.LOGOUT')];
        ...
        <AppBar position="static">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { md: 'flex', lg: 'none', xl: 'none' } }}>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex', lg: 'none' } }}>
                        <Button className='link-element' onClick={() => handleCloseUserMenu(3)} >
                            <ExitToAppIcon />
                            <Typography sx={{ textAlign: 'center', marginLeft: 1, textTransform: 'none' }} >{t('CONTENTS.NAV.LOGOUT')}</Typography>
                        </Button>
                    </Box>
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'none', lg: 'flex' }, width: '260px' }}>
                        ...
                        >
                            {settings.map((setting, i) => (
                                <MenuItem key={setting} onClick={() => handleCloseUserMenu(i)}>
                                    ...
                                    {i == 2 && <LockOpenIcon />}
                                    {i == 3 && <ExitToAppIcon />}
                                    <Typography sx={{ textAlign: 'center', marginLeft: 1 }}>{setting}</Typography>
                                </MenuItem>
                            ))}
                        </Menu>
                    </Box>
